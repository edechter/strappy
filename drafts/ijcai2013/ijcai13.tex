...
\begin{circuitikz}
\draw
(1.0,0) node[nand port, scale=.5] (nand1) {}
(2.0,0) node[nand port, scale=.5] (nand2) {}
% (0, 0) node (x) {x}
% (0, 0) node (y) {y}
...
node[nand port, scale=.5, right=1cm of x] (nand1) {}
node[nand port, scale=.5, right=1cm of y] (nand2) {}
node[nand port, scale=.5, below right=.3cm and 1cm of nand2] (nand3) {}
(x) -| (nand1.in 1)
(x) -| (nand1.in 2)
(y) -| (nand2.in 1)
(y) -| (nand2.in 2)
...
\begin{circuitikz}
\draw
node[nand port, scale=.5] (nand1) {}
node[nand port, scale=.5, above right=.3cm and 1cm of nand1] (nand2) {} 
node[nand port, scale=.5, below right=.3cm and 1cm of nand1] (nand3) {} 
node[nand port, scale=.5, right=2cm of nand1] (nand4) {} 
