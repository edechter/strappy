...
We propose the \textbf{EC algorithm}, an iterative procedure to solve this
...
The EC algorithm maintains a distribution $\mathcal{D}$ over
...
\begin{figure}[ht]
\centering
\includegraphics[width=.8\linewidth]{figures/symreg3frontiers.pdf}
\vspace{-.2cm}
...
\begin{figure}[ht]
\centering
\includegraphics[width=.8\linewidth]{figures/symRegDiffCurricula.pdf}
...
What does the EC algorithm learn in this task?  Inspecting the top
