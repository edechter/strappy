...
Motivation: Many approaches to constructive machine learning use structured representations, such as graphs, grammars, Horn clauses. All of these may be thought of as a program - programs are at least as expressive as these other representations.

The space of programs is enormous and inherently unpredictable \cite{PACunpredictability}.
We introduce a new algorithm, SEC, (TODO: Sequential EC? SEC? What is a good name for this?) for searching the space of programs.
...
Applications: graphical model structure, towers

The SEC algorithm is motivated by a generative model over compositions of functions drawn from a stochastic grammar over programs.

SEC treats inference as a planning problem
