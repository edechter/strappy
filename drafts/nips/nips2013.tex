...
\includegraphics[width=.5\linewidth]{./figures/cylinderCombinator.pdf}
...
\end{lstlisting}
\vfill
\caption{The combinatory calculus expression tranlated into \textsc{Haskell}-like syntax for readability.}
% \end{minipage}
\end{subfigure}
\end{minipage}
\end{comment}
%\caption{An example of solution SEC finds to solve \textsc{Cylinder}\label{ref:cylinder}}
\end{figure}
