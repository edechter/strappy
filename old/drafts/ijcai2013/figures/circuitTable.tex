...
\begin{tikzpicture}
\node (x) at (0,0) {$x$};
\node (f)[above right=.1 and .6cm of x, draw=blue!75, fill=blue!25, text width=.6cm] {$f(\cdot)$};
\node (g)[below right=.1 and .6cm of x, draw=red!75, fill=red!25, text width=.6cm] {$g(\cdot)$};
...
\node (y) at (0,1cm) {$y$};
\node (x) at (0,0cm) {$x$};
\node (nand)[nand gate US, draw, below right=0cm  and .2cm of y] {};
...
\begin{tikzpicture}
\node (x) at (0, 0cm) {$x$};
\node (f)[right=.4cm of x, draw=blue!75, fill=blue!25, text width=.6cm] {$f(\cdot)$};
\node (nand) [nand gate US, draw, above right=0cm and .7cm of f] {};
\node (f2)[right=.4cm of nand, draw=blue!75, fill=blue!25, text width=.6cm] {$f(\cdot)$};
...
\begin{tabular}{p{.02\linewidth}p{.95\linewidth}}
 ~ & 
  \begin{tabular}{|m{.5cm}|m{2.5cm}|m{4cm}|}
    \hline
